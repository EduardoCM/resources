(function() {
	...
	app.config(function($stateProvider, $urlRouterProvider, $controllerProvider){
		...
		$stateProvider
			...
			.state('alumnos',{
	        url:'/alumnos',
	        templateUrl: viewsPrefix + 'alumnos.html',
	        controller:'AlumnoListController'
	    }).state('viewAlumno',{
	       url:'/alumnos/:id/view',
	       templateUrl: viewsPrefix + 'alumno-view.html',
	       controller:'AlumnoViewController'
	    }).state('newAlumno',{
	        url:'/alumnos/new',
	        templateUrl: viewsPrefix + 'alumno-add.html',
	        controller:'AlumnoCreateController'
	    }).state('editAlumno',{
	        url:'/alumnos/:id/edit',
	        templateUrl: viewsPrefix + 'alumno-edit.html',
